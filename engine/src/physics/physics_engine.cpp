...
namespace EngineY {
    ...
    void PhysicsEngine::SubmitDebugRendering() {
        ...
        ENGINE_ASSERT(physics_world != nullptr , "Attempting to submit debug rendering without a physics world");
...
*/
        rp3d::PolygonVertexArray* pva = ynew(
            rp3d::PolygonVertexArray , 
